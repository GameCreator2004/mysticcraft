...
public class StoneTile extends Tile {
	...
	public void render(Screen screen, Level level, int x, int y) {
		...
		screen.render(x * 16 + 0, y * 16 + 0, 32, Color.get(rc1, level.dirtColor, rc2, rc3, -1), 0); // renders
																									// the
																									// top-left
																									// part
																									// of
																									// the
																									// tile
		screen.render(x * 16 + 8, y * 16 + 0, 32, Color.get(rc1, level.dirtColor, rc2, rc3, -1), 0); // renders
																									// the
																									// top-right
																									// part
																									// of
																									// the
																									// tile
		screen.render(x * 16 + 0, y * 16 + 8, 32, Color.get(rc1, level.dirtColor, rc2, rc3, -1), 0); // renders
																									// the
																									// bottom-left
																									// part
																									// of
																									// the
																									// tile
		screen.render(x * 16 + 8, y * 16 + 8, 32, Color.get(rc1, level.dirtColor, rc2, rc3, -1), 0); // renders
																									// the
																									// bottom-right
																									// part
																									// of
