...
public class Tile {
	protected int creativeDmg = 999;
	public static int tickCount = 0; // A global tickCount used in the Lava &
										// water tiles.
	protected Random random = new Random(); // Random is used for random numbers
											// (duh!).

	public static Tile[] tiles = new Tile[568]; // An array of tiles
	public static Tile grass = new GrassTile(0); // creates a grass tile with
													// the Id of 0, (I don't
	...
	public static Tile treeSapling = new SaplingTile(9, grass, tree); // tree
																		// sapling;
																		// plant
																		// on
																		// grass,
																		...
																		// a
																		// tree
	public static Tile cactusSapling = new SaplingTile(10, sand, cactus); // cactus
																			// sapling;
																			// plant
																			// on
																			// sand,
	...
	public static Tile stairsDown = new StairsTile(14, false); // Stairs leading
																// down
	public static Tile stairsUp = new StairsTile(15, true); // Stairs leading up
	public static Tile infiniteFall = new InfiniteFallTile(16); // Air tile in
																// the sky.
	...
	public boolean connectsToGrass = false; // sees if the tile connects to
											// grass
	...
	public boolean connectsToWater = false; // sees if the tile connects to
											// water
	...
	public Tile(int id) {
		...
		if (tiles[id] != null)
			throw new RuntimeException("Duplicate tile ids!"); // You cannot
																// have
																// over-lapping
																// id
