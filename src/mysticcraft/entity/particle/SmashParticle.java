...
public class SmashParticle extends Entity {
	...
	public void render(Screen screen) {
		int col = Color.get(-1, 555, 555, 555, -1);// color of the particle (white)
		screen.render(x - 8, y - 8, 5 + 12 * 32, col, 2); // renders the
															// top-left part
		screen.render(x - 0, y - 8, 5 + 12 * 32, col, 3); // renders the
															// top-right part
		screen.render(x - 8, y - 0, 5 + 12 * 32, col, 0); // renders the
															// bottom-left part
		screen.render(x - 0, y - 0, 5 + 12 * 32, col, 1); // renders the
															// bottom-right part
	}
}
